...
const EXTENSION_FILES = ['manifest.json', 'background.js', 'content.js', 'sidepanel.html', 'sidepanel.css', 'sidepanel.js', 'rules.json', 'drive-api.js', 'image-processor.js', 'file-converter.js', 'chat-memory.js', 'm365-copilot.js'];
